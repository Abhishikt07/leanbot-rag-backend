...
from Day_19_E import log_chatbot_interaction, get_all_indexed_urls, update_cached_answer, log_lead_data
from language_middleware import LanguageTranslator # New Import
...
if st.session_state.regenerate_index != -1:
    ...
    with st.chat_message("assistant"):
        ...
        new_response_en, new_source, new_distance, new_metadata, _, query_to_cache,lead_score_raw, _ = regenerate_answer(
